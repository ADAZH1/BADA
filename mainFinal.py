...
def run_active_adaptation(args, source_model, src_dset, num_classes, device):
    ...
    test_acc, cm_before = utils.test(source_model, device, target_test_loader, split="test",
    ...
    print("原始train_test_loader: " + out_str)
...
def main():
    ...
    run_active_adaptation(args, best_source_model, src_dset, num_classes, device)
